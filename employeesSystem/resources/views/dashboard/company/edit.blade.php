...
<div class="form">
    ...
    <div class="subtitle">Edit this company!</div>
    
     <form action="{{route('companies.update',$company->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
    <div class="input-container ic1">
      <input class="input" type="text" value="{{ $company->name }}" name="name" value="{{ $company->name }}"/>
      <div class="cut"></div>
    ...
    <div class="input-container ic2">
      <input class="input" type="email" value="{{ $company->email }}" placeholder=" " name="email"/>
      <div class="cut"></div>
    ...
    <div class="input-container ic2">
      <input class="input" type="text" placeholder=" " value="{{ $company->website }}" name="website"/>
    ...
    <div class="input-container ic2" style="color:white">
      ...
      <img src="images/logos/{{ $company->logo }}" style="width:200px;maxheight:300px">
      @error('logo')
      <div class="alert alert-danger mt-1 mb-1" style="color:white">{{ $message }}</div>
      @enderror
